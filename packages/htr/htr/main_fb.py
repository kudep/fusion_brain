...
class FilePaths:
    ...
    fn_char_list = data_dir / 'model/charList.txt'
    fn_summary = data_dir / 'model/summary.json'
    fn_corpus = data_dir / 'data/corpus.txt'
...
def main(args):
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default=data_dir /'data/word.png')
